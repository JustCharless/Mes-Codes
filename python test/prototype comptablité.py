# NOTES REPÈRES CODAGE DE PROJETS POUR S'ENTRAINER

# Fait de ton mieux pour faire des programmes de comptabilité afin de se facilité la vie 
# exemple une fonction pour faire l'écriture comptable de façon automatique si possible 
# sinon essayer de remproduire via le code un pseudo-logiciel comptable où je rentre 
# juste les valeurs puis ça construit l'écriture comptable (tableau + débit/crédit etc...)
# avec une possibilité de enregistré en PDF ou word comme ça avec POWER QWERY on peut mettre 
# sur excel de façon propre.
# 
# exemple automatisater les écriture courantes (vente / achat / avoir / facture nn parvenue /
# rémunération du personnel / dépréciations / ammortissement / charges constatées d'avance etc
#
#
## A TOI DE JOUER ## 
